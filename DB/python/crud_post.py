...
#INSERT (게시)
sql = "INSERT INTO posts (id, author, content) VALUES (%s, %s, %s)"
user_data = (id, author, content)
...
cursor.execute("SELECT * FROM posts WHERE id = %s AND author = %s", (id, author))
posts = cursor.fetchall()

if posts:
    print(id)
    print(f"등록된 게시물 {posts[0]}")
else:
    print("검색 결과에 해당하는 게시물이 없습니다.")
