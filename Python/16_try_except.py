...
#number = int("help") #ValueError: invalid literal for int() with base 10: 'help'
#print(shop.index("x")) #ValueError: list.index(x): x not in list < 리스트에 x라는 인자가 없다란 뜻
...
#4. NameError
# 존재하지 않는 변수를 호출할 때
#print(x) NameError: name 'x' is not defined < x 정보가 없다. 
