...
console.log('user 원본', user);

//for ~ in
for (let key in user){
    console.log('key:', key, '| value', user[key]);
}
//[key]라고 안 쓰고 .key 하면 undefined 나온다.

//객체
// 문자열, 숫자, 배열 내장 메서드가 존재 (ex. concat, filter, sort...)
// 하지만 객체는 내장 메서드 X
//  객체는 키/값을 쌍으로 가지고 있다는 구조만 명확하고 
//  해당 값의 타입, 의미, 용도가 전부 제각각이므로
