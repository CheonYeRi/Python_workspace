...
//문자열의 전개
const spread2 = [...'HELLO'];
console.log(spread2); //(5) ['H', 'E', 'L', 'L', 'O']
...
function myFunc(a,b,c, ...rest){
    //순서대로 받고 나머지 rest에 넣어줘
    console.log(a,b,c);
    console.log("rest", rest);
}

myFunc(...values); //rest (2) ['라', '마']

const {flavor, ...rest} = potatoChip;
console.log(flavor); //어니언
console.log(rest); //{base: '포카칩', company: '오리온'}
